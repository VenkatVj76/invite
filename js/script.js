...
var countDownDate = new Date("Apr 30, 2026 10:30:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'>" +
        "<div class='days block'><div>" + days + "</div><div>Days</div></div>" +
        "<div class='hours block'><div>" + hours + "</div><div>Hours</div></div>" +
        "<div class='minutes block'><div>" + minutes + "</div><div>Minutes</div></div>" +
        "<div class='seconds block'><div>" + seconds + "</div><div>Seconds</div></div>" +
        "</div>";
